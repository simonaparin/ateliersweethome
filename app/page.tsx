...
export const metadata: Metadata = {
  title: "Atelier Sweet Home | Работа со старыми домами в Грузии",
  description: "Обследование, реконструкция, новая крыша, летние кухни и навесы для старых частных домов. Тбилиси, Кахетия, вся Грузия.",
  alternates: { canonical: "/", languages: { ru: "/", en: "/en", ka: "/ge" } },
  openGraph: { title: "Atelier Sweet Home | Работа со старыми домами в Грузии", description: "Сохраняем старые дома и возвращаем их к жизни.", url: "/", siteName: siteConfig.name, locale: "ru_GE", type: "website", images: [{ url: "/images/reconstruction/hero/house-t-restored-clean.png", width: 1280, height: 960, alt: "Восстановленный дом Atelier Sweet Home" }] }
};
